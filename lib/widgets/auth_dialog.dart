import 'package:lbt/screens/home_page.dart';
import 'package:lbt/utils/authentication.dart';
                ...
                Row(
                  ...
                  children: [
                    ...
                    PSCodeCheckingWidget(
                      ...
                      dotCount: 10,
                      codeGenerator: SizedCodeGenerator(size: 5),
                    ),
                    SizedBox(width: 20),
                    SizedBox(
                      width: 200,
                          ...
                          child: TextButton(
                            ...
                            onPressed: () async {
                              if (!controller
                                ...
                                setState(() {
                                  loginStatus = 'Неверный код с картинки';
